   ...
   class mysql {
      ...
      */
      function connexion() {
          ...
          return $this->cBD = mysqli_connect("localhost", $strNomAdmin, $strMotPasseAdmin, $this->nomBD) or die(str_replace("<br/><br/>", 10)."<strong>".$this->strErrConnect."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      ...
      */
      function creeTableNormale($strNomTable, $strContenu) {
          ...
          return $this->OK = mysqli_query($this->cBD, $this->requete) or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrCreation."</strong>".str_replace("<br/><br/>", 10));
      }
      ...
      */
      function deconnexion() {
          return $this->OK = mysqli_close($this->cBD) or die(str_replace("<br/><br/>", 10)."<strong>".$this->strErrDeconnexion."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      | effaceDonnees
      ...
      */
      function effaceDonnees($strNomTable, $strRequete) {
          ...
          return $this->OK = mysqli_query($this->cBD, $this->requete) or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrSuppresion."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      ...
      */
      function insereDonnees($strNomTable) {
          ...
          return $this->OK = mysqli_query($this->cBD, $this->requete) or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrInsertion."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      | insereEnregistrement
      ...
      */
      function modifieDonnees($strNomTable, $strDonnees) {
          ...
          return $this->OK = mysqli_query($this->cBD, $this->requete) or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrUpdate."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      | modifieChamp
      ...
      */
      function retourneSelect($strNomTable, $strDonnees) {
          ...
          $this->OK = mysqli_query($this->cBD, $this->requete) or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrSelect."</strong>".str_replace("<br/><br/>", 10));
      ...
      */
      function selectionneBD() {
          return $this->OK = mysqli_select_db($this->cBD, $this->nomBD) or die(str_replace("<br/><br/>", 10)."<strong>".$this->strErrSelectDB."</strong>".str_replace("<br/><br/>", 10));
      }
      /*
      |----------------------------------------------------------------------------------|
      | supprimeDonnees
      ...
      */
      function supprimeTable($strNomTable) {
          if (func_num_args()==1) {
              ...
              mysqli_query($this->cBD, "set FOREIGN_KEY_CHECKS = 1; ") or die(str_replace("<br/><br/>", 10)."<strong>".$strNomTable.", ".$this->requete."<br/><br/>".$this->strErrSuppresion."</strong>".str_replace("<br/><br/>", 10));
          }
      }
      /*
      |----------------------------------------------------------------------------------|
