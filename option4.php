...
require_once "classe-validation-projetfinal-03-05-2018-Doyon.php";
    ...
    if (!$fchListeEtudiants->existe()) {
        ...
        while (!$fchListeEtudiants->detecteFin()) {
            ...
            if ($intEtat == etat_ValidationGeneral) {
                ...
                //Nom utilisateur
                if (array_key_exists($tabNomChampsFichier[0], $tabLigneTraiter) && ($tabValidation[2] === TRUE)) {

                    //valide si n'est pas déjà utilisé
                    if (validation::valid_nomUtilisateur($tabLigneTraiter[$tabNomChampsFichier[0]], $tabLigneTraiter[$tabNomChampsFichier[2]])) {
